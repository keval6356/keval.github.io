...
(() =>{
     ...
     projectDetailsBtn = popup.querySelector(".pp-porject-details-btn");
     ...
     function popupSlideshow(){
     	...
     	/* activate Loader untill the papupImg loaded */
     ...
     function popupDetails(){
     	...
     	popup.querySelector(".pp-porject-details").innerHTML = details;
     	...
     	popup.querySelector(".pp-porject-category").innerHTML = category.split("-")
     	  .join(" ");
     }
